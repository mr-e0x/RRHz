...
echo -e $bu  " Tools       : Mr.E0x-TOOLS          " 
echo -e $bu  " Author      : KOYUZU PADILAH REVOER  " 
echo -e $bu  " Contact     : 085782666*** $white " 
echo -e $bu  "KALO GA BISA GAUSAH MAKE TOOLS INI YAH TOD:v :)  "
...
echo -e $bu "Subscribe To Channel==> Nyamuk moba <==[        ga subskreb auto mandul kere boss:v]"
read -p "====>" pil  ;
